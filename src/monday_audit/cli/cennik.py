"""Odświeżanie cennika ze stron monday i przegląd stawek.
    ...
    uv run python -m monday_audit.cli.cennik --odswiez
    uv run python -m monday_audit.cli.cennik --pokaz --klient cxlabs
...
from monday_audit.agent.cennik import (
    CennikError,
    przeglad,
    zapisz_stawke,
)
