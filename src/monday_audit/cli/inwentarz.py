"""Sześć kafelków dla konta monday — pierwszy ekran z user story.
    ...
    uv run python -m monday_audit.cli.inwentarz
    uv run python -m monday_audit.cli.inwentarz --json
...
from monday_audit.obraz.inwentarz import zbuduj_inwentarz
from monday_audit.obraz.przeglad_tablic import PrzegladTablic, pobierz_tablice, zbuduj_przeglad
from monday_audit.obraz.wejscie_analizy import zbuduj_wejscie
from monday_audit.obraz.zestawienia import WynikZestawien, zbuduj_zestawienia
from monday_audit.zbieranie.itemy import WynikItemow, zbuduj_itemy
from monday_audit.zbieranie.klient import MondayClient, MondayError
from monday_audit.zbieranie.konto import Zakres, rozpoznaj_konto
