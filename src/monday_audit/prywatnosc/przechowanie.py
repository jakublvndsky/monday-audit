...
from monday_audit.prywatnosc.maskowanie import WZORZEC_TELEFONU, zamaskuj
from monday_audit.zbieranie.osoby import DLUGOSC_HASHA, WZORZEC_EMAILA, unikalny_klucz
