...
from monday_audit.zbieranie.klient import WERSJA_API
...
from monday_audit.zbieranie.postep import LicznikKonsolowy
from monday_audit.zbieranie.przebieg import BUDZET_STARTOWY, RaportRunu, wykonaj_run
...
def zbuduj_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="monday_audit.stary_panel.cli",
