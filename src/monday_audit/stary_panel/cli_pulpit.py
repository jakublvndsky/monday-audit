"""Renderowanie makiety dashboardów (front, makieta).
    ...
    uv run python -m monday_audit.stary_panel.cli_pulpit                  # wszyscy klienci
    uv run python -m monday_audit.stary_panel.cli_pulpit --klient cxlabs   # jeden
...
def zbuduj_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="monday_audit.stary_panel.cli_pulpit",
...
def main(argv: list[str] | None = None) -> int:
    ...
    logging.getLogger("monday_audit.stary_panel.pulpit").setLevel(logging.INFO)
