...
def zbuduj_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="monday_audit.stary_panel.cli_raport",
...
def main(argv: list[str] | None = None) -> int:
    ...
    logging.getLogger("monday_audit.stary_panel.raport").setLevel(logging.INFO)
    logging.getLogger("monday_audit.prywatnosc.deanonimizacja").setLevel(logging.INFO)
