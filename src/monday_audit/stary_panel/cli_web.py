"""Serwer aplikacji webowej i zarządzanie kontami dostępu (D16).
    ...
    uv run python -m monday_audit.stary_panel.cli_web --serwuj
    uv run python -m monday_audit.stary_panel.cli_web --dodaj-klienta kancelaria-ekologiczna
    uv run python -m monday_audit.stary_panel.cli_web --dodaj-osobe jle@cxlabs.digital
    uv run python -m monday_audit.stary_panel.cli_web --zresetuj-haslo kancelaria-ekologiczna
...
from monday_audit.stary_panel.web.api import przygotuj_baze, zbuduj_aplikacje
...
def zbuduj_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="monday_audit.stary_panel.cli_web",
