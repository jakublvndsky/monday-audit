...
from monday_audit.detekcja.rubryka import Rubryka
from monday_audit.prywatnosc.deanonimizacja import Deanonimizacja
from monday_audit.raport.srodowisko import KATALOG_SZABLONOW, srodowisko, zasob_data_uri
from monday_audit.stary_panel.raport import (
    ODBIORCA_KLIENT,
    ODBIORCA_WEWNETRZNY,
    ODBIORCY,
    Finding,
...
from monday_audit.zbieranie.osoby import RODZAJE_AGENTOW
