...
from monday_audit.agent.sesja import SCIEZKA_PROMPTU_ANALIZY, zbuduj_zadanie
from monday_audit.detekcja.detektory import Hipoteza
...
def test_prompt_analizy_istnieje_i_ma_blok() -> None:
    ...
    from monday_audit.agent.sdk import _tekst_promptu
...
def test_budzet_jest_na_sesje_a_nie_na_hipoteze() -> None:
    ...
    from monday_audit.agent.sdk import MAKS_OBROTOW
    from monday_audit.agent.sesja import BUDZET_NARZEDZI, MAKS_OBROTOW_ANALIZY
...
async def test_brak_hipotez_przerywa_zamiast_placic_za_pusta_sesje() -> None:
    from monday_audit.agent.sdk import AgentError
...
def test_zombie_account_idzie_szablonem_a_nie_do_modelu() -> None:
    ...
    from monday_audit.agent.sesja import rozdziel_hipotezy
...
def test_surowa_odpowiedz_laduje_na_dysku(tmp_path: Any) -> None:
    ...
    from monday_audit.cli.analiza import zapisz_surowa_odpowiedz
...
def test_sufit_nie_rusza_klas_ponizej_i_zachowuje_kolejnosc() -> None:
    from monday_audit.agent.sesja import przytnij_do_sufitu
...
def test_odpowiedz_pocieta_na_bloki_sklada_sie_w_calosc() -> None:
    ...
    from monday_audit.agent.sesja import odpowiedz_z_blokow
...
def test_pokrycie_pelne_gdy_kazda_hipoteza_dokladnie_raz() -> None:
    from monday_audit.agent.sesja import sprawdz_pokrycie
