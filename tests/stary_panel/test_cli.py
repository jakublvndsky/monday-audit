...
from monday_audit.stary_panel.cli import eksportuj, ustal_baze, zbuduj_parser
from monday_audit.zbieranie.konto import zbuduj_zakres
from monday_audit.zbieranie.logi import MAKS_STRON_LOGOW, TOP_PO_ITEMACH, Z_OGONA
from monday_audit.zbieranie.przebieg import RaportRunu, zapisz_snapshot
...
async def test_brak_sekretow_daje_jasny_komunikat(tmp_path: Path) -> None:
    ...
    from monday_audit.stary_panel.cli import uruchom
...
def test_token_opuszcza_secretstr_dokladnie_raz() -> None:
    ...
    przewróci ten test.
    """
    from monday_audit.stary_panel import cli
...
def test_na_klase_jest_w_parserze() -> None:
    ...
    from monday_audit.stary_panel.cli_agent import zbuduj_parser
