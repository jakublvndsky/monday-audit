...
def test_zbieranie_konczy_sie_na_zgodzie_a_nie_na_agencie(
    ...
    """
    from monday_audit.stary_panel.web import run as modul_run
...
def test_zgoda_na_cale_konto_nie_zaweza(
    ...
    """
    from monday_audit.stary_panel.web import api as modul_api
...
def test_podglad_klucz_nie_idzie_w_url(
    ...
    monkeypatch.setattr("monday_audit.stary_panel.web.api.MondayClient", Atrapa)
...
def test_porzucenie_zwalnia_konto_na_kolejny_audyt(klient_http: TestClient, baza: Path) -> None:
    ...
    """
    from monday_audit.stary_panel.zadania import wolno_odpalic
...
def test_nie_da_sie_porzucic_audytu_w_analizie(klient_http: TestClient, baza: Path) -> None:
    ...
    zrezygnować.
    """
    from monday_audit.stary_panel.zadania import STAN_ANALIZUJE, utworz_zadanie, zapisz_stan
...
def test_padniety_hook_nie_przerywa_analizy(
    ...
    from monday_audit.stary_panel.agent import zbadaj_hipotezy
    from monday_audit.stary_panel.web import run as modul_run
