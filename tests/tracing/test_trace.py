...
from monday_audit.tracing.trace import RODZAJ_GENERACJA, zbuduj_trace
from monday_audit.zbieranie.osoby import WpisPII
...
async def test_petla_faktycznie_wysyla_trace(monkeypatch: Any) -> None:
    ...
    from monday_audit.stary_panel import agent as modul_agenta
...
def _trace_analizy(**nadpisz: Any) -> Any:
    from monday_audit.tracing.trace import zbuduj_trace_analizy
...
def test_hasz_obrazu_nie_zalezy_od_kolejnosci_kluczy() -> None:
    ...
    from monday_audit.tracing.trace import hasz_obrazu
...
def test_wspolna_wysylka_przelyka_awarie_sieci(caplog: Any) -> None:
    from monday_audit.tracing.trace import wyslij_bezpiecznie
...
def test_stara_sciezka_korzysta_z_tej_samej_reguly() -> None:
    ...
    from monday_audit.stary_panel import agent
...
def test_wejscie_generacji_jest_rozmowa_z_haszami() -> None:
    ...
    from monday_audit.agent.sesja import zbuduj_zadanie
    from monday_audit.detekcja.detektory import Hipoteza
