...
def test_obie_sciezki_zapisuja_tyle_samo() -> None:
    ...
    """
    korzen = Path(__file__).resolve().parents[2] / "src" / "monday_audit" / "stary_panel"
...
def test_do_probki_logow_ida_tablice_bez_aktywnego_wlasciciela() -> None:
    ...
    from monday_audit.zbieranie.przebieg import _bez_aktywnego_wlasciciela
